...
\title{[Not a final name, needs work] TRISO Reactor Fuel Enrichment and Cyclus Archetype Timing}
...
\degreeyear{2024}
\committee{Professor Kathryn D. Huff, UIUC \\ Assistant Professor Madicken Munk, OSU \\ Professor Rizwan Uddin, UIUC}
...
\chapter{Archetype Time Management}
\label{ch:time}
\glsresetall
