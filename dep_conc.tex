...
\begin{itemize}
    ...
    \item MMR and Xe-100 Serpent models are based on small amounts of publicly available information and are not based on confidential or proprietary information. They also assume that the \gls{haleu} fueled \gls{triso} reactors will first accept \gls{leu+} fuel and operate at the same power level and similar burnup.
    \item We assume that reactors will transition from \gls{leu+} to \gls{haleu} fuel when it becomes available at the same time in 2040.
    \item
\end{itemize}
