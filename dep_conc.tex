...
% The mass of fresh fuel required to deploy the reactors as proposed in this thesis is staggering. As shown in Table \ref{tab:fresh_incs}, the percentage increase of average fresh fuel mass from the no-growth scenario to the double scenario mirrors the values from Table \ref{tab:swu_incs}.
