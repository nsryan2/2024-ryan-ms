...
actors, but it reveals the implications of deploying a minimal number of reactors to meet the demand.
...
In Figure \ref{fig:swu_yearly_greedy}, the yearly \gls{swu} demand
periodically spikes as the demand for enrichment services grows to meet the fuel
...
As the features of the yearly data are regular and dictated by the reactor's cycle, we will visualize the total \gls{swu} demand in the cumulative plots in Figures \ref{fig:greedy_mf_swu} and \ref{fig:greedy_of_swu}.
...
In Table \ref{tab:greedy_swu_avg}, we show how the \gls{swu} demand for the \gls{mmr} and \gls{xe} reactors is the same in the single and multi-fuel regimes for the no growth scenarios, consistent with the reactor deployment trends we have seen in Section \ref{sec:greedy_reactors}. The \gls{swu} demand for the AP1000s increases by 800\% from the no growth scenario to the double scenario, again consistent with the reactor deployment trends we have seen in the previous section. The \gls{swu} demand for \gls{xe} \gls{haleu} increases by 167\%, while the \gls{swu} demand for \gls{mmr} \gls{haleu} increases by 105\% from the no growth scenario to the double scenario.
...
In Figures \ref{fig:greedy_mf_fresh} and \ref{fig:greedy_of_fresh}, we show the fresh fuel demand for the reactors in the no growth and double by 2050 scenarios. The fresh fuel curves in each scenario follow the same pattern as the reactor deployment curves, as \cyclus supplies fuel to each of the reactors as it is deployed.
