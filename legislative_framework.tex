...
\begin{figure}[!ht]
  \subfloat[First sub-figure\label{subfig-1:percent}]{%
    \includegraphics[width=0.494\textwidth]{images/proportional_fuel_use.jpg}
 }
  \hfill
  \subfloat[Total energy\label{subfig-2:total}]{%
    \includegraphics[width=0.515\textwidth]{images/total_fuel_use.jpg}
 }
  \caption{
